 ...
 */
package net.mudcrab.coursework.mbsd.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import java.util.Map;
import net.mudcrab.coursework.mbsd.ide.contentassist.antlr.internal.InternalIfictiondslParser;
...
public class IfictiondslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, IfictiondslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPrimaryAccess().getInnerAssignment_0_2(), "rule__Primary__InnerAssignment_0_2");
			...
			builder.put(grammarAccess.getSystemStateChangeNodeAccess().getTransitionAssignment_10(), "rule__SystemStateChangeNode__TransitionAssignment_10");
