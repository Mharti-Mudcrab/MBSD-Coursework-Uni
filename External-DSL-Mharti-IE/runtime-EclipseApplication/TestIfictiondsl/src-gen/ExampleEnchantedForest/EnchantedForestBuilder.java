	...
	public void build() throws IllegalStateException {
		Story("EnchantedForest")
			...
			.Choice("roadChoice")
				...
				.ChoiceOption("Impossible choice")
					.Transition("hardToGetToNode", 1, "HardToGetValue==1")
						
			.Dialogue("hardToGetToNode",
					"How did we get here!?")
				.Transition("furtherDownTheDeadBranch")
						
			.Dialogue("furtherDownTheDeadBranch",
					"")
				.Transition("shieldChoice")
						
			.Dialogue("notRefferencedByAnyNode",
					"")
				.Transition("shieldChoice")
						
			.SystemStateChange("addTalismanSystemStateChange",
					"You found a Talisman! It looks important!\nAdded the talisman to backpack ",
					"Talisman=1, Coin+=10, Cucumber-=1")
				.Transition("roadChoice")
			...
			.Choice("shieldChoice")
				.ChoiceOption("Go back to start")
					.Transition("start")
				.ChoiceOption("Tell a nock nock joke and see what happens")
					.Transition("nockNockJokeStateChange")
			...
			.SystemStateChange("nockNockJokeStateChange",
					"A rythmic humming is emitted from the shield for a few seconds and 5 pearls fall into the grass in front of you",
					"Pearl+=5")
				.Transition("shieldChoice")
			...
			.Choice("movePastWitchChoice")
				.ChoiceOption("Go back to start")
					.Transition("start")
				.ChoiceOption("Show her your bag full of pearls")
					.Transition("buyTheWitch", 2, "Pearl>50")
				.ChoiceOption("Go past her")
					.Transition("walkPastWitch", 2, "Talisman==1")
					.Transition("witchBadEnd")
						
			.SystemStateChange("buyTheWitch",
					"The witch melts at the sight of your pearly whites and dissolves into the ground...\n	Wait where are the pearls!?\n You suddenly have no pearls left",
					"Pearl=0")
				.Transition("abruptBadEnd", 2, "Talisman==2")
